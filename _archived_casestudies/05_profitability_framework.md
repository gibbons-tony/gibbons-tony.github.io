...
{% include figure.liquid path="assets/img/casestudies/profitability/situation.jpg" class="img-fluid rounded z-depth-1" style="max-width: 45%; float: right; margin: 0 0 20px 20px;" zoomable=true %}
...
{% include figure.liquid path="assets/img/casestudies/profitability/task.jpg" class="img-fluid rounded z-depth-1" style="max-width: 50%; float: left; margin: 0 20px 20px 0;" zoomable=true %}
...
{% include figure.liquid path="assets/img/casestudies/profitability/action.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
<div class="caption">
...
{% include figure.liquid path="assets/img/casestudies/profitability/result.jpg" class="img-fluid rounded z-depth-1" style="max-width: 50%; float: right; margin: 0 0 20px 20px;" zoomable=true %}
