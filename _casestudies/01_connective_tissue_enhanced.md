...
metrics:
  - value: "50 → 225+"
    label: "Team Growth (4.5x in 2 years)"
  - value: "6 Functions"
    label: "Sales, GTM, Finance, M&A, Engineering"
  - value: "Flywheel"
    label: "Self-Reinforcing Growth Created"
---
...
**Successfully grew the org from 50 to 225+ people in less than two years:**

- **Year 1:** 50 → 120 (2.4x growth)
- **Year 2:** 120 → 225+ (1.9x growth)
- **Total:** 4.5x growth while improving efficiency

### Strategic Impact

**The insights from this analytics function directly drove our GTM and M&A decisions:**

- **GTM Strategy:** Data showed which partnerships drove highest ROI
- **M&A Decisions:** Analytics identified acquisition targets that filled capability gaps
- **Resource Allocation:** Predictive models optimized engineering investment
- **Sales Enablement:** Partner scorecards accelerated deal velocity

### The Flywheel Continues

The flywheel effect created sustainable growth:

- **Self-reinforcing:** Each success made the next one easier
- **Compounding trust:** Cross-functional relationships strengthened over time
- **Institutional knowledge:** Shared data language became embedded in culture
- **Scalable processes:** What worked at 50 people still worked at 225+
...
Built robust analytics infrastructure:
- **Data Platform:** BigQuery for unified analytics
- **Visualization:** Tableau dashboards for each function
- **Automation:** Python scripts for reporting
- **APIs:** Connected Salesforce, JIRA, SAP, and internal tools

### The Human Element

But technology alone wasn't enough:
- **Relationship building:** 1:1s with leaders from each function
- **Active listening:** Understanding each group's real challenges
- **Diplomatic navigation:** Managing competing priorities
- **Celebration culture:** Publicly recognizing cross-functional wins

## The Long-Term Impact

### Organizational DNA Changed

The changes persisted beyond my tenure:
- **Cross-functional collaboration** became the norm
- **Data-driven decisions** replaced opinion-based debates
- **Shared accountability** for company-wide metrics
- **Trust networks** that outlasted individual contributors

### Personal Growth

This role shaped my leadership philosophy:
- **Systems thinking:** See the whole organization as interconnected
- **Bridge building:** Value connection as much as creation
- **Multiplier effect:** Enable others to be more effective
- **Strategic patience:** Trust and culture take time to build
